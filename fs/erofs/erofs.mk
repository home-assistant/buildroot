...
ifeq ($(BR2_TARGET_ROOTFS_EROFS_LZ4),y)
ROOTFS_EROFS_ARGS += -zlz4
else ifeq ($(BR2_TARGET_ROOTFS_EROFS_LZ4HC),y)
ROOTFS_EROFS_ARGS += -zlz4hc,$(strip $(BR2_TARGET_ROOTFS_EROFS_LZ4HC_LEVEL))
else ifeq ($(BR2_TARGET_ROOTFS_EROFS_LZMA),y)
ROOTFS_EROFS_ARGS += -zlzma,$(strip $(BR2_TARGET_ROOTFS_EROFS_LZMA_LEVEL))
